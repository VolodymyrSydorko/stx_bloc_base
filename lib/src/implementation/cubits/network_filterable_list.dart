...
/// A utility class that combines search and filtering functionality with list manipulation methods.
///
///Example usage:
///
///```dart
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit] to perform search asynchronously.
///   @override
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit] to perform filtering asynchronously.
///   @override
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit] to add new item asynchronously.
///   @override
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit] to edit an item asynchronously.
///   @override
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit] to remove an item asynchronously.
...
///   }
///
///   // Can optionally be overridden when extending [NetworkFilterableListCubit].
///   @override
...
///```dart
/// TextButton(
///   onPressed: () => context.read<MyNetworkFilterableListCubit>().addItemAsync(
...
/// TextButton(
///   onPressed: () => context
///       .read<MyNetworkFilterableListCubit>()
...
/// ```dart
/// TextField(
///  onChanged: context.read<MyNetworkFilterableListCubit>().searchAsync,
/// ),
/// ```
///
...
/// TextButton(
///     onPressed: () =>
///         context.read<MyNetworkFilterableListCubit>().updateAsync([
...
/// ```dart
/// TextButton(
///     onPressed: () => context.read<MyNetworkFilterableListCubit>().update([
